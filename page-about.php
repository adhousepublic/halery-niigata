            ...
            <img src="<?php echo get_template_directory_uri(); ?>/common/images/common/elmt-ika-7.svg" class="stage_1_the_ika" alt="">
                ...
                <section class="sp_halery_stage_section sp_halery_stage_section-2">
                  <div class="sp_halery_stage_content stage_scene_2_content">
                    ...
                    <div class="stage_2_halery">
                      <span class="stage_2_halery_wrap">
                        <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-1.svg" class="stage_2_the_graph" alt="ワ、ワカメ、いらいらいらいらいらんかの？">
                      </span>
                    </div>
                  </div>
                </section>

                <section class="sp_halery_stage_section sp_halery_stage_section-3">
                  <div class="sp_halery_stage_content stage_scene_3_content">
                    <h2 class="sp_halery_stage_content_title">
                      <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-caption-2.png" class="d_img" alt="第ニ章 魅力的な商品">
                    </h2>
                    <p class="stage_description stage_3_desc stage_3_desc_1">
                      <span class="stage_desc_text stage_3_desc_text">
                        そのうち家業を手伝い始めた<br>
                        息子の二代目(現代表)。<br>
                        初代と共にワカメを販売しつつも、<br>
                        もっと魅力的な商品を求めた末に<br>
                    ...
                    <div class="stage_3_halery">
                      <span class="stage_3_halery_wrap">
                        <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-2.svg" class="stage_3_the_graph" alt="うめえ！これなら売れるべ！なぁ!?t">
                      </span>
                    </div>
                  </div>
                </section>

                <section class="sp_halery_stage_section sp_halery_stage_section-4">
                  <div class="sp_halery_stage_content stage_scene_4_content">
                    <h2 class="sp_halery_stage_content_title">
                      <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-caption-3.png" class="d_img" alt="第三章 誕生・イカ人間">
                    </h2>
                    <p class="stage_description stage_4_desc stage_4_desc_1">
                      <span class="stage_desc_text stage_4_desc_text">
                        順調に思われたおつまみ販売ですが、<br>
                        初代に負けず劣らずの<br>
                        人見知りに成長した二代目は<br>
                        魅力的なおつまみを販売するも<br>
                    ...
                    <p class="stage_description stage_4_desc stage_4_desc_2">
                      <span class="stage_desc_text stage_4_desc_text">
                        ｢何かうまい方法はないものか｣と悩んでいると、<br>
                        目の前に現れた人気の名刺屋さんが一言。<br>
                        ｢イカの姿だと、勝手に声をかけてもらえるよ｣<br>
                        予言的なアドバイスをされた二代目は<br>
                        ｢だったらイカに変身してみようかな〜｣と<br>
                        あっさりその気になりました。<br><br>
                        そして…
                      </span>
                    </p>
                    <div class="stage_4_halery">
                      <span class="stage_4_halery_wrap">
                        <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-3.svg" class="stage_4_the_graph" alt="お、おつまみ、いかいかいかいかいかがですか？">
                      </span>
                    </div>
                  </div>
                </section>

                <section class="sp_halery_stage_section sp_halery_stage_section-5">
                  <div class="sp_halery_stage_content stage_scene_5_content">
                    <h2 class="stage_description stage_5_desc">
                      <span class="stage_desc_text stage_5_desc_text">
                        人見知りを吹き飛ばす、<br>
                        イカ人間が誕生したのでした。
                      </span>
                    </h2>
                    <div class="stage_5_halery">
                      <span class="stage_5_halery_wrap">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-4-1.svg" class="stage_5_the_graph" alt="これでおつまみを販売してみよう！">
                      </span>
                    </div>
                  </div>
                </section>

                <section class="sp_halery_stage_section sp_halery_stage_section-6">
                  <div class="sp_halery_stage_content stage_scene_6_content">
                    <h2 class="sp_halery_stage_content_title">
                      <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-caption-4.png" class="d_img" alt="第四章 実は話好き？">
                    </h2>
                    <p class="stage_description stage_6_desc stage_6_desc_1">
                      <span class="stage_desc_text stage_6_desc_text">
                        こうして唐突に誕生したイカ人間でしたが、<br>
                        いい変化はすぐに訪れます。<br>
                        最初はイベントで遠巻きに<br>
                        様子をうかがっていた人々が、<br>
                        ヘンテコでもの珍しい風貌の<br>
                    ...
                    <div class="stage_6_halery">
                      <span class="stage_6_halery_wrap">
                        <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-5-1.svg" class="stage_6_the_graph sp_visible" alt="あのイカ、前も見たわ何者かしら…">
                      </span>
                    </div>
                  </div>
                </section>

                <section class="sp_halery_stage_section sp_halery_stage_section-7">
                  <div class="sp_halery_stage_content stage_scene_7_content">
                    <h2 class="stage_description stage_7_desc">
                    <span class="stage_desc_text stage_7_desc_text">
                      イカの頭に手ごたえを感じ、<br>
                      さらに奥の手アイテムを編み出します。<br>
                      その名は｢試食棒｣。<br>
                      試食コーナーで自然にできてしまう、<br>
                      お客様との距離は約<i class="stage_desc_text_rotate stage_desc_text_rotate_single">2</i> ｍ。<br>
                      声をかけられないよう設けられた<br>
                      心と体の溝を、<br>
                      埋める道具を発明したのです。<br>
                      この棒は長い柄杓のようなもの。<br>
                      ディスタンスは保ちつつ、<br>
                      棒だけがニョキニョキとお客様に近づき、<br>
                      好奇心から試食に<br>
                      手を出してしまうという仕掛けです。<br>
                      イカの姿で注目を集め、試食棒で回収する。<br>
                      射程距離は約<i class="stage_desc_text_rotate">20</i>ｍにおよぶと推測しています。
                    ...
                    <div class="stage_7_halery">
                      <span class="stage_7_halery_wrap">
                        <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-5-2.svg" class="stage_7_the_graph" alt="今だ…！">
                      </span>
                    </div>
                  </div>
                </section>

                <section class="sp_halery_stage_section sp_halery_stage_section-8">
                  <div class="sp_halery_stage_content stage_scene_8_content">
                    <h2 class="stage_caption stage_8_caption decort_text">
                      <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-caption-5.png" class="d_img" alt="最終章 マジメにふざけて、喜び合いたい">
                    </h2>
                    <p class="stage_description stage_8_desc stage_8_desc_1">
                      <span class="stage_desc_text stage_8_desc_text">
                        お客様を呼び込むことが苦手だった二代目が、<br>
                        変身 + アイテムによって手に入れたもの。<br>
                        それは｢おもしろそう！｣と感じてもらい、<br>
                        人々が気軽にワチャワチャ<br>
                        集まってくる場をつくる術。<br>
                        こうして世の中が気づいていない<br>
                        スキマ的な魅力を掘り起こし、<br>
                        ...
                        お客様も大いに喜んでくれる形。<br>
                        これからもハレリーならではの行商スタイルと、<br>
                        大マジメに繰り広げられる楽しいおふざけに<br>
                        どうぞおつき合いくださいね。
                      </span>
                    </p>
                    <div class="stage_8_halery">
                      <span class="stage_8_halery_wrap"><img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-6.svg" class="stage_8_the_graph" alt="末長いご愛顧をどうぞよろしくお願いします"></span>
                    </div>
                  </div>
                </section>
