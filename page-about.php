        ...
        <div class="inner_content">
          ...
          <div class="stage_wrap w_max1366 sp_visible">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-1.png" class="stage_2_the_graph" alt="ワ、ワカメ、いらいらいらいらいらんかの？">
                ...
                <section class="sp_halery_stage_section sp_halery_stage_section-3">
                  <div class="sp_halery_stage_content stage_scene_3_content">
                    ...
                    <p class="stage_description stage_3_desc stage_3_desc_1">
            <span class="stage_desc_text stage_3_desc_text">そのうち家業を手伝い始めた息子の二代目(現代表)。<br>
            初代と共にワカメを販売しつつも、<br>
            もっと魅力的な商品を求めた末に<br>
            問屋さんから紹介された｢おつまみ｣に辿り着きます。
            </span>
                    ...
                    <p class="stage_description stage_3_desc stage_3_desc_2">
            <span class="stage_desc_text stage_3_desc_text">おつまみ販売の反応がよく、やがておつまみが主力商品に。<br>
            あまり世に知られていない美味しいおつまみが<br>
            全国にたくさんあることを知ったハレリーは、<br>
            この美味しさを世に届けることを決意したのでした。
            </span>
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-2.png" class="stage_3_the_graph" alt="うめえ！これなら売れるべ！なぁ!?t">
                ...
                <section class="sp_halery_stage_section sp_halery_stage_section-4">
                  <div class="sp_halery_stage_content stage_scene_4_content">
                    ...
                    <p class="stage_description stage_4_desc stage_4_desc_1">
            <span class="stage_desc_text stage_4_desc_text">順調に思われたおつまみ販売ですが、<br>
            初代に負けず劣らずの人見知りに成長した二代目は<br>
            魅力的なおつまみを販売するも<br class="sp_none">
            人前で話をすると顔が真っ赤になる始末。<br>
            必要不可欠なお客様の呼び込みにも<br class="sp_none">
            ドギマギしてしまいました。
                    ...
                    <p class="stage_description stage_4_desc stage_4_desc_2">
            <span class="stage_desc_text stage_4_desc_text">｢何かうまい方法はないものか｣と悩んでいると、<br>
            目の前に現れた人気の名刺屋さんが一言。<br>
            ｢イカの姿だと、勝手に声をかけてもらえるよ｣<br>
            予言的なアドバイスをされた二代目は<br>
            ｢だったらイカに変身してみようかな〜｣と<br class="sp_none">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-3.png" class="stage_4_the_graph" alt="お、おつまみ、いかいかいかいかいかがですか？">
                ...
                <section class="sp_halery_stage_section sp_halery_stage_section-5">
                  <div class="sp_halery_stage_content stage_scene_5_content">
                    <h2 class="stage_description stage_5_desc">
            <span class="stage_desc_text stage_5_desc_text">人見知りを吹き飛ばす、<br>
            イカ人間が誕生したのでした。
            </span>
                    </h2>
                    <div class="stage_5_halery">
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-4-1.png" class="stage_5_the_graph" alt="これでおつまみを販売してみよう！">
                ...
                <section class="sp_halery_stage_section sp_halery_stage_section-6">
                  <div class="sp_halery_stage_content stage_scene_6_content">
                    ...
                    <p class="stage_description stage_6_desc stage_6_desc_1">
            <span class="stage_desc_text stage_6_desc_text">こうして唐突に誕生したイカ人間でしたが、<br>
            いい変化はすぐに訪れます。<br>
            最初はイベントで遠巻きに様子をうかがっていた人々が、ヘンテコでもの珍しい風貌のイカ人間に引き寄せられ、｢○○○○にいましたよね｣とよく話しかけられるように。<br>
            そこで判明したのは<br>
            ｢オレ、人見知りだけど、話好きなんだ｣という性格。<br>
            そんなこじらせ系のイカ人間も、今では小学生に大人気。<br>
            ただし<i class="stage_desc_text_rotate stage_desc_text_rotate_single">1</i> 〜<i class="stage_desc_text_rotate stage_desc_text_rotate_single">2</i> 歳のこどもの半数は未確認生物にギャン泣きするので、そっと人間の姿に戻ることもしばしばです。
            </span>
                    </p>
                    <div class="stage_6_halery">
            <span class="stage_6_halery_wrap">
            <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-5-1.png" class="stage_6_the_graph sp_visible" alt="あのイカ、前も見たわ何者かしら…">
                ...
                <section class="sp_halery_stage_section sp_halery_stage_section-7">
                  <div class="sp_halery_stage_content stage_scene_7_content">
                    <h2 class="stage_description stage_7_desc">
            <span class="stage_desc_text stage_7_desc_text">イカの頭に手ごたえを感じ、<br>
            さらに奥の手アイテムを編み出します。<br>
            その名は｢試食棒｣。<br>
            試食コーナーで自然にできてしまう、お客様との距離は約<i class="stage_desc_text_rotate stage_desc_text_rotate_single">2</i> ｍ。<br>
            声をかけられないよう設けられた心と体の溝を、<br>
            埋める道具を発明したのです。<br>
            この棒は長い柄杓のようなもの。<br>
            ディスタンスは保ちつつ、棒だけがニョキニョキとお客様に近づき、好奇心から試食に手を出してしまうという仕掛けです。<br>
            イカの姿で注目を集め、試食棒で回収する。<br>
            射程距離は約<i class="stage_desc_text_rotate">20</i>ｍにおよぶと推測しています。
            </span>
                    </h2>
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/common/images/about/stage-graph-5-2.png" class="stage_7_the_graph" alt="今だ…！">
                ...
                <section class="sp_halery_stage_section sp_halery_stage_section-8">
                  <div class="sp_halery_stage_content stage_scene_8_content">
                    ...
                    <p class="stage_description stage_8_desc stage_8_desc_1">
            <span class="stage_desc_text stage_8_desc_text">お客様を呼び込むことが苦手だった二代目が、変身 + アイテムによって手に入れたもの。<br>
            それは｢おもしろそう！｣と感じてもらい、人々が気軽にワチャワチャ集まってくる場をつくる術。<br>
            こうして世の中が気づいていないスキマ的な魅力を掘り起こし、お客様とそのおいしさや楽しさを共有する使命を獲得しました。<br>
            めざすのは自分自身が楽しめて、<br">
            お客様も大いに喜んでくれる形。<br>
            これからもハレリーならではの行商スタイルと、大マジメに繰り広げられる楽しいおふざけにどうぞおつき合いくださいね。
            </span>
                    </p>
                    <div class="stage_8_halery">
